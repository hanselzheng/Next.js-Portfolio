    ...
    <div className='py-20' id='projects'>
        ...
        <div className='flex flex-wrap items-center justify-center p-4 gap-16'>
            {projects.map(({id, title, des, img, iconLists, link}) => (
                <div key={id} className='sm:h-[41rem] h-[32rem] lg:min-h-[32.5rem] sm:w-[570px] w-[80vw] flex items-center justify-center'>
                    <PinContainer 
                      title={link} 
                      href={link}
                    >
                        <div className="relative flex items-center justify-center sm:w-[570px] w-[80vw] overflow-hidden m:h-[40vh] h-[30vh] mb-10">
